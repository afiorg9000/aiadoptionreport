...
import { marketProfileReferences } from "@/data/marketProfileReferences";
...
const MarketProfileReferences = () => {
  ...
  return (
    <section id="mp-references" className="py-16 bg-muted/50">
...
export default MarketProfileReferences;
